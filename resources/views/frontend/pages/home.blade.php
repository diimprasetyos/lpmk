            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h2 data-aos="fade-down">Selamat Datang di <br><span>SI - LPMK</span></h2>
                        <p data-aos="fade-up">Sistem Informasi LPMK (Lembaga Pemberdayaan Masyarakat Kelurahan) adalah sebuah
                            aplikasi yang dirancang untuk membantu pengelolaan data dan informasi yang berkaitan dengan
                            kegiatan pemberdayaan masyarakat di tingkat kelurahan.</p>
