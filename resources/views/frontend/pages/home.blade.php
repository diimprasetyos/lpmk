...
<section id="hero" class="hero">
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/lpmk/banner-2.jpg)">
        </div>
        <div class="carousel-item" style="background-image: url(assets/img/lpmk/banner-1.jpeg)"></div>
